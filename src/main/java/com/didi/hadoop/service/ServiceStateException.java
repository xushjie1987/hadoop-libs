...
public class ServiceStateException extends RuntimeException {
     ...
     * that type, it is typecast to a {@link RuntimeException} and returned. All other exception
     * types are wrapped in a new instance of ServiceStateException
     * 
     * @param fault
    ...
    public static RuntimeException convert(String text,
        ...
        if (fault instanceof RuntimeException) {
            ...
            return new ServiceStateException(text,
                                             fault);
        }
    }
}

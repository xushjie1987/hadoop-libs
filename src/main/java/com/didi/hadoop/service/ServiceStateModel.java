...
public class ServiceStateModel {
    ...
    private static final boolean[][] statemap = {
            ...
            /* uninited */ {false, true, false, true}, /* inited */ {false, true, true, true}, /* started */ {false, false, true, true}, /* stopped */ {false, false, false, true},};
    ...
    public static void checkStateTransition(String name,
        ...
        if (!isValidStateTransition(state,
                                    proposed)) {
    ...
    /**
     * Is a state transition valid? There are no checks for current==proposed as that is considered
     * a non-transition. using an array kills off all branch misprediction costs, at the expense of
     * cache line misses.
     *
     * @param current
     *            current state

...
/**
 * This class contains a set of methods to work with services, especially to walk them through their
 * lifecycle.
 */
public final class ServiceOperations {
     ...
     * <p/>
     * The service state is checked <i>before</i> the operation begins. This process is <i>not</i>
     * thread safe.
     * 
     * @param service
     *            a service or null
    ...
    /**
     * Stop a service; if it is null do nothing. Exceptions are caught and logged at warn level.
     * (but not Throwables). This operation is intended to be used in cleanup operations
     *
     * @param service
     ...
     */
    public static Exception stopQuietly(Log log,
                                        Service service) {
        try {
            stop(service);
        } catch (Exception e) {
    ...
    /**
     * Class to manage a list of {@link ServiceStateChangeListener} instances, including a
     * notification loop that is robust against changes to the list during the notification process.
     */
    public static class ServiceListeners {
        /**
         * List of state change listeners; it is final to guarantee that it will never be null.
         */
        private final List<ServiceStateChangeListener> listeners = new ArrayList<ServiceStateChangeListener>();
        
        /**
         * Thread-safe addition of a new listener to the end of a list. Attempts to re-register a
         * listener that is already registered will be ignored.
         * 
         * @param l
         *            listener
         */
        ...
        /**
         * Change to a new state and notify all listeners. This method will block until all
         * notifications have been issued. It caches the list of listeners before the notification
         * begins, so additions or removal of listeners will not be visible.
         * 
         * @param service
